...
The easiest way to create beautiful user profiles with WordPress. UserPlus plugin allowing front-end login, user registration ,Customize form builder and edit profile. 
...
<li><strong>Custom Profile Fields:</strong>
<ul>
	<li> Unlimited custom fields for profiles and/or registration (text, drop-down, radio, checkboxes, etc.)</li>
...
* Front end profile 
* Ultimate Login & Registration form with shortcode
* Custom form fields
...
3. UserPlus menu will appear in Dashboard->UserPlus. 
...
Q.want more feature?
 ...
 Drop Mail :wpuserplus@gmail.com
